                ...
                <div className="w-80 border-r border-gray-200 p-6 flex flex-col bg-gray-50 overflow-y-auto">
                    <div className="flex-1 flex flex-col">
                        ...
                        <textarea 
                            ...
                            className="w-full flex-1 min-h-[200px] p-4 rounded-xl border border-gray-200 focus:ring-2 focus:ring-pink-500 focus:border-transparent outline-none resize-none text-sm bg-white shadow-sm mb-4"
                        />
                        <button 
                            onClick={handleGenerate}
                            disabled={isGenerating || !prompt.trim()}
                            className="w-full bg-gradient-to-r from-pink-500 to-purple-600 text-white py-3 rounded-xl font-medium hover:opacity-90 disabled:opacity-50 flex items-center justify-center gap-2 shadow-md transition-all active:scale-[0.98]"
                        >
                        ...
                        <div className="animate-[fadeIn_0.5s_ease-out]">
                             <div className="flex items-center justify-between mb-6 pb-4 border-b border-gray-100">
                                ...
                                <div className="flex gap-2">
                                    <button onClick={() => navigator.clipboard.writeText(result)} className="p-2 hover:bg-gray-100 rounded text-gray-500 transition-colors" title="Copy to Clipboard">
                                        <Copy size={16} />
                                    </button>
                                </div>
                             </div>
