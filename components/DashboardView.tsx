                                    ...
                                    taskStats.urgentTasks.slice(0, 5).map(task => (
                                        <div key={task.id} className="p-4 hover:bg-gray-50 transition-colors flex items-center justify-between group">
                                            ...
                                            <button 
                                                ...
                                                className="opacity-0 group-hover:opacity-100 px-3 py-1.5 text-xs font-medium text-indigo-600 bg-indigo-50 rounded-md transition-all"
                                            >
                                                View
                                            </button>
                                        </div>
                            ...
                            <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                                {projectStats.activeProjects.length === 0 ? (
                                    ...
                                    projectStats.activeProjects.map(project => (
                                        <div key={project.id} className="border border-gray-100 rounded-lg p-4 hover:shadow-md transition-shadow bg-gray-50/30">
